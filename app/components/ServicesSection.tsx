...
export default function ServicesSection() {
  const services: Service[] = [
    ...
    },
    {
      ...
      description:
        "Developing fast, scalable web applications with clean code and smooth navigation.",
      example:
        "Implemented a SPA with React Router for seamless user experience during my Codveda internship.",
    },
    {
      title: "Copywriting",
      description:
  ...
  return (
    <section
      id="services"
      className="section-padding bg-gradient-to-tr from-indigo-900 via-purple-900 to-indigo-900"
    >
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {services.map(({ title, description, example }) => (
            <article
              key={title}
            ...
            >
              <div className="mb-6">
                {/* Icon placeholder - replace with real icons if you want */}
              ...
              <p className="text-indigo-100 flex-grow">{description}</p>
